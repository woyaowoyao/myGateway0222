...
import com.ibm.sp.gateway.SpGatewayApp;
import com.ibm.sp.gateway.config.SecurityBeanOverrideConfiguration;
...
@SpringBootTest(classes = {SecurityBeanOverrideConfiguration.class, SpGatewayApp.class})
public class HibernateTimeZoneTest {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM sp_date_time_wrapper where id=%d", fieldName, id);
    }
