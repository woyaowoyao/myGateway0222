package com.ibm.sp.user.repository;

import com.ibm.sp.user.SmartPlanGateway6BApp;
import com.ibm.sp.user.config.Constants;
import com.ibm.sp.user.config.audit.AuditEventConverter;
import com.ibm.sp.user.domain.PersistentAuditEvent;
...
import static com.ibm.sp.user.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
