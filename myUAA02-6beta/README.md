...
To build the final jar and optimize the myUAA02 application for production, run:
...
[Using UAA for Microservice Security]: https://www.jhipster.tech/documentation-archive/v6.0.0-beta.0/using-uaa/[Using JHipster in development]: https://www.jhipster.tech/documentation-archive/v6.0.0-beta.0/development/
